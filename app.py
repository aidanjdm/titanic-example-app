...
githublink = 'https://github.com/aidanjdm/titanic-example-app'
...
####### Layout of the app ########
app.layout = html.Div([
    html.H3('Choose a dimension for summary statistics:'),
    dcc.Dropdown(
        id='dropdown',
...
def display_value(continuous_var):
    results=pd.DataFrame(df.groupby(['Sex', 'Survived'])[continuous_var].mean())
    ...
    mylayout = go.Layout(
        title='Average Values for Selected Measure',
        xaxis = dict(title = 'Survived?'), # x-axis label
